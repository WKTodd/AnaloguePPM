...
;    Date:     17/09/1991 to 21/12/2020                               *
;    File Version:      2.2   
;  improvements to DCoffset adjustment	
...
;save  Right channel and test peak
	    movwf	ARinH		;save right channel bits 9-2
...
saveLch	    bcf		Control,ADCch	;toggle channel to right ch
	    ...
	    banksel	CM1CON0
	    bcf		CM1CON0,C1POL
	    btfss	status,c	;test sign bit 0=+ve
	    bra		posleft
...
outphz	    ;out of phase so dec to -50
	    addwf	Phase,w
	    subwf	PhaseL,f
	    btfss	status,c
	    decf	Phase,f	    
