...
;==================================< main loop >===================================
;
mainlp:	    call	DoFrmSlot	;do one frame slot 
...
DoFrmSlot:  movf	FrmNo,w	    ;do one of 19x 250uS slots between frames
	    ...
	    return			;7
	    return			;8	    
	    return  ;goto	DcFltL	;9 do dc filter average
	    return  ;goto	DcFltR	;10 do dc filter average
	    return			;11
	    return			;12	    
	    return			;13
	    return			;14	    
...
DCFltL:	    ;average input to filter out dc 
	    movlb	1		;select bank1
	    decfsz	DFCntL,f
	    bra		dcsetl
	    movf	DcFtL2,w	;get sum/256
	    btfss	DCFtL2,7	;test neg
	    bra		dcposl
	    xorlw	0xff		;rectify
	    addlw	0x01		;add 1 so -1 = 1
dcposl	    movwf	DCOSL		;save for later
	    clrf	DcFtL0
	    clrf	DcFtL1
	    clrf	DcFtL2
	    movlb	0
...
dcsetl	    movf	ALinL,w		;left add low byte
	    addwf	DcFtL0,f
	    movf	ALinH,w
	    addwfc	DcFtL1,f	
	    movlw	0
...
DCFltR:	    
	    ...
	    decfsz	DFCntR,f
	    bra		dcsetr
	    movf	DcFtR2,w	;bits 9-1
	    btfss	DcFtR2,7
	    bra		dcposr
	    xorlw	0xff		;rectify
	    addlw	0x01		;add 1 so -1 = 1
dcposr	    movwf	DCOSR		;save for later
	    clrf	DcFtR0
	    clrf	DcFtR1
	    clrf	DcFtR2
	    movlb	0
...
dcsetr	    movf	ARinL,w		;average right low byte
	    addwf	DcFtR0,f
	    movf	ARinH,w
	    addwfc	DcFtR1,f	
	    movlw	0
